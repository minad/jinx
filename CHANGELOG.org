...
- Add =jinx-correct-nearest=, =jinx-correct-all= and =jinx-correct-at-point= commands.
  The command =jinx-correct= dispatches to one of those commands depending on the
  prefix argument.
