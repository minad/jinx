...
The completion menu is compatible with all popular completion UIs: default
completion, Icomplete, Vertico, Ivy and Helm. In case you use Vertico I suggest
that you tweak the completion display via =vertico-multiform-mode= for the
