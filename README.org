...
In case you use my [[https://github.com/minad/vertico][Vertico]] completion UI I suggest that you tweak the completion
display via =vertico-multiform-mode= for the completion category =jinx=. You can for
