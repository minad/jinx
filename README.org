...
and supports multiple backends like [[https://nuspell.github.io/][Nuspell]], [[https://hunspell.github.io/][Hunspell]] and [[http://aspell.net/][Aspell]].
...
- =C-u M-$= or =M-x jinx-correct-all= triggers correction for the entire buffer.
